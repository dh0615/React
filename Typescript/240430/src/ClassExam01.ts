class Employee {
  // 필드
  protected name: string; // 자동으로 public이라는 접근 제어자의 속성을 가지고 있음
  public age: number; // 자동으로 public이라는 접근 제어자의 속성을 가지고 있음
  public position: string; // 자동으로 public이라는 접근 제어자의 속성을 가지고 있음
